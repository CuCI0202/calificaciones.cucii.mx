...
const MOCK_PROGRAMS: Program[] = [
  {
    ...
    terms: 10,
    subjects: [
      { id: 101, code: 'MAT-101', name: 'Matemáticas I', term: 1, credits: 8 },
      { id: 102, code: 'MAT-102', name: 'Comunicación Oral y Escrita', term: 1, credits: 6 },
      { id: 103, code: 'MAT-103', name: 'Introducción a la Programación', term: 2, credits: 8 },
      { id: 104, code: 'MAT-104', name: 'Matemáticas II', term: 2, credits: 8 },
      { id: 105, code: 'MAT-105', name: 'Programación Orientada a Objetos', term: 3, credits: 8 },
      { id: 106, code: 'MAT-106', name: 'Base de Datos I', term: 3, credits: 8 },
      { id: 107, code: 'MAT-107', name: 'Estructuras de Datos', term: 4, credits: 8 },
      { id: 108, code: 'MAT-108', name: 'Desarrollo Web I', term: 4, credits: 6 },
    ],
  },
  {
    id: 2,
    ...
    terms: 9,
    subjects: [
      { id: 201, code: 'ADE-201', name: 'Fundamentos de Administración', term: 1, credits: 8 },
      { id: 202, code: 'ADE-202', name: 'Contabilidad General', term: 1, credits: 6 },
      { id: 203, code: 'ADE-203', name: 'Mercadotecnia I', term: 2, credits: 8 },
      { id: 204, code: 'ADE-204', name: 'Recursos Humanos', term: 2, credits: 8 },
    ],
  },
];
